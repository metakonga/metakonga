...
particleManager* dem_model::CreateParticleManager()
{
	if (!pm)
		pm = new particleManager;
	return pm;
...
void dem_model::Save(QTextStream& qts)
{
	qts << "DEM_MODEL_DATA" << endl
		<< "INTEGRATOR " << integration_type << endl
		<< "SORT " << sort_type << endl;
...
void dem_model::Open(QTextStream& qts)
{
	QString ch;
	int itype = 0;
	int stype = 0;
	qts >> ch >> itype >> ch >> stype;
	integration_type = (dem_integrator::Type)itype;
	sort_type = (grid_base::Type)stype;
}

// cylinder* dem_model::makeCylinder(QString _name, tMaterial _mat, tRoll _roll)
// {
...
// }
// 
// cube* dem_model::makeCube(QString _name, tMaterial _mat, tRoll _roll)
// {
...
// }
// 
// plane* dem_model::makePlane(QString _name, tMaterial _mat, tRoll _roll)
// {
...
// }
// 
// polygonObject* dem_model::makePolygonObject(tImport tm, QString file)
// {
// 	QFile qf(file);
...
// kinematicConstraint* dem_model::makeKinematicConstraint(QString _name, tKinematicConstraint kt,
...
// }
// 
// mass* dem_model::makeMass(QString _name)
// {
...
// particle_system* dem_model::makeParticleSystem(QString _name)
// {
// // 	if (!ps)
...
// drivingConstraint* dem_model::makeDrivingConstraint(QString _name, kinematicConstraint* kconst, tDriving td, double val)
// {
...
// collision* dem_model::makeCollision(QString _name, double _rest, double _fric, double _rfric, double _coh, double _ratio, tCollisionPair tcp, tContactModel tcm, void* o1, void* o2)
// {
// 	collision* c = NULL;
// 	switch (tcp){
...
// void dem_model::opendem_model(GLWidget *gl, QString& file)
// {
// 	QFile pf(file);
...
// void dem_model::runExpression(double ct, double dt)
// {
// 	if (objs.size()){
// 		foreach(object* value, objs)
// 		{
...
// }
// 
// unsigned int dem_model::numPolygonSphere()
// {
// 	unsigned int _np = 0;
// 	if (npoly)
// 	{
...
// void dem_model::comm(QString com)
// {
// 	pte->appendPlainText(com);
// }

// void dem_model::actionDelete(const QString& tg)
// {
