...
//	if (fileFormat == 'b'){
//		int vecSize = 4;
//		float tme = step * Simulation<float>::dt;
//		char partName[256] = { 0, };
...
//			of.write((char*)&tme, sizeof(float));
//			of.write((char*)&sim->Balls()->Np(), sizeof(unsigned int));
//			of.write((char*)&sim->Balls()->Color(), sizeof(int));
//			of.write((char*)&sim->Balls()->Radius(0), sizeof(float));
//			of.write((char*)sim->Balls()->Position(), sizeof(vector4<float>)*sim->Balls()->Np());
//			of.write((char*)sim->Balls()->Velocity(), sizeof(vector4<float>)*sim->Balls()->Np());
//			/*for (unsigned int i = 0; i < sim->NBall(); i++){
//				particles* b = &sim->Balls()[i];
...
//					vector3<float> vel = 0.0;
//					vector3<float> force = 0.0;
//					int type = MASS;
//					of.write((char*)&type, sizeof(int));
...
//					of.write((char*)&sh->Position(), sizeof(vector3<float>));
//					of.write((char*)&vel, sizeof(vector3<float>));
//					of.write((char*)&force, sizeof(vector3<float>));
//				}
//			}
//		}
//		else{
