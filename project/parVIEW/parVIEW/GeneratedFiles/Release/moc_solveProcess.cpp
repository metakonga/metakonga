...
#include "../../../../common/inc/solveProcess.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_solveProcess_t, stringdata) + ofs \
...
void *solveProcess::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_solveProcess.stringdata))
