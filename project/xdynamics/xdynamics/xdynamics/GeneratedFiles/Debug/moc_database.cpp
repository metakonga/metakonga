...
QT_MOC_LITERAL(1, 9, 14), // "propertySignal"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 19), // "context_object_type"
QT_MOC_LITERAL(4, 45, 11) // "contextMenu"

    },
    "database\0propertySignal\0\0context_object_type\0"
    "contextMenu"
};
...
void database::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->propertySignal((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< context_object_type(*)>(_a[2]))); break;
        ...
        {
            typedef void (database::*_t)(QString , context_object_type );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&database::propertySignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void database::propertySignal(QString _t1, context_object_type _t2)
{
