...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_cubeDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 21, 12) // "Click_cancel"
    ...
    "cubeDialog\0Click_ok\0\0Click_cancel"
};
...
void *cubeDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cubeDialog.stringdata))
