...
void solveProcess::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&solveProcess::valueChanged)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&solveProcess::finished)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (solveProcess::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&solveProcess::spSignal)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject solveProcess::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_solveProcess.data,
      qt_meta_data_solveProcess,  qt_static_metacall, nullptr, nullptr}
};
