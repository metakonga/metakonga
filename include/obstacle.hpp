#ifndef OBSTARCLE_HPP
#define OBSTARCLE_HPP
...
public:
	...
	sphydrodynamics* initialize()
	{
		...
		geo::line *bottom_wall1 = new geo::line(isph, BOUNDARY, "bottom_wall");
		bottom_wall1->define(VEC3F(0.0f, 0.f, 0.f), VEC3F(0.4f, 0.f, 0.f), true, true);

		geo::line *bottom_wall2 = new geo::line(isph, BOUNDARY, "bottom_wall");
		bottom_wall2->define(VEC3F(0.45f, 0.f, 0.f), VEC3F(0.5f, 0.f, 0.f), true, true);

		geo::line *left_wall = new geo::line(isph, BOUNDARY, "left wall");
		left_wall->define(VEC3F(0.0f, 0.5f, 0.f), VEC3F(0.0f, 0.0f, 0.0f), true);

		geo::line *ob_left = new geo::line(isph, BOUNDARY, "ob_left");
		ob_left->define(VEC3F(0.4f, 0.0f, 0.0f), VEC3F(0.4f, 0.05f, 0.0f), true, false, true);
		ob_left->innerDefine(VEC3F(0.4f, 0.05f, 0.0f));

		geo::line *ob_top = new geo::line(isph, BOUNDARY, "ob_top");
		ob_top->define(VEC3F(0.4f, 0.05f, 0.0f), VEC3F(0.45f, 0.05f, 0.0f), true, false, true);
		ob_top->innerDefine(VEC3F(0.4f, 0.05f, 0.0f));
		ob_top->innerDefine(VEC3F(0.45f, 0.05f, 0.0f));

		geo::line *ob_right = new geo::line(isph, BOUNDARY, "ob_right");
		ob_right->define(VEC3F(0.45f, 0.05f, 0.0f), VEC3F(0.45f, 0.f, 0.f), true, false, true);
		ob_top->innerDefine(VEC3F(0.45f, 0.05f, 0.0f));
