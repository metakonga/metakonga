...
public:
	...
	bool setUp()
	{
		...
		VEC3D CarBody_position(0.0, 0.0, 0.0);
		
		// Left Front Suspension
		lfw = { 15.0, -0.98833311, -0.67800231, -0.16953447, 1.0, 0.0, 0.0, 0.0, }
		...
		//CarBody
		pointMass* CarBody = createPointMass("CarBody", 500, VEC3D(552.20658885, 869.75107357, 1141.92974516),	VEC3D(0.0, 0.0, 0.0), CarBody_position);//246326396293451,552,869,1141
