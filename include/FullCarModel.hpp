...
public:
	...
	bool setUp()
	{
		...
		//	 //CarBody
		//rigidBody* CarBody = createRigidBody("CarBody", 2.26396293451,
		//		VEC3D(5.20658885, 8.75107357, 11.92974516),
		//		VEC3D(0.0, 0.0, 0.0),
		//		CarBody_position);//2463,552,869,1141
		//	CarBody->setVelocity(VEC3D(10, 0, 0));
		//	//CarBody fixed Joint
...
// 		LF_wheel_position);
		...
		spi = ground->toLocal(LF_CarBody_SUW_REV_location - ground->Position());
		...
		spi = ground->toLocal(LF_CarBody_SDW_REV_location - ground->Position());
		...
		springDamperModel* LF_SUS = createSpringDamperElement(
			...
			ground, LF_SUS_UPPER_location, 10000000.0, 1000000);
		...
		*/
		...
		//	CarBody, RF_SUS_UPPER_location, 10000.0, 1000);
		...
		*/
		...
		//	CarBody, LR_SUS_UPPER_location, 10000.0, 1000);
		...
		//	CarBody, RR_SUS_UPPER_location, 10000.0, 1000);

		//Steer Bar constraint
		spi = ground->toLocal(LF_CarBody_Steer_Bar_SPH_location - ground->Position());
